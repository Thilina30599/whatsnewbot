...
module.exports = {
    VERSION: 'thilina-bot 2.0.0 - Full Control',
    CHANNEL: 'https://t.me/thilauna',
    ...
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'Coded By Thilina \n\n Join The Telegrame Group \nt.me/SewQueen\n\n' : process.env.ALIVE_MESSAGE,
    ...
    CPK: process.env.CAPTION_NAME === undefined ? 'Coded By t.me/thilauna' : process.env.CAPTION_NAME,
    ...
    OWNERSHIP: process.env.OWNER_SHIP === undefined ? 'Thilina Methsahan' : process.env.OWNER_SHIP,
    BOTNAME: process.env.YOUR_BOT_NAME === undefined ? 'ᵀʰⁱˡⁱⁿᵃᴮᵒᵗ' : process.env.YOUR_BOT_NAME,
