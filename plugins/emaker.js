...
QueenSew.newcmdaddtosew({pattern: '1best$', fromMe: sk, dontAdCommandList: true}, (async (message, match) => {
    ...
    const msg =command_cmd + '```.sl6neon``` \n' + desc_cmd + t77 + '_\n' + usage_cmd + '.sl6neon Thilina\n\n' +
        command_cmd + '```.sl4graf``` \n' + desc_cmd + t67 + '_\n' + usage_cmd + '.sl4graf Thilina\n\n' +
        command_cmd + '```.sl5graf``` \n' + desc_cmd + t74 + '_\n' + usage_cmd + '.sl5graf Thilina\n\n' +
        command_cmd + '```.sl2space``` \n' + desc_cmd + t68 + '_\n' + usage_cmd + '.sl2space Thilina\n\n' +
        command_cmd + '```.sl3space``` \n' + desc_cmd + t72 + '_\n' + usage_cmd + '.sl3space Thilina\n\n' +
        command_cmd + '```.sl2gradient``` \n' + desc_cmd + t76 + '_\n' + usage_cmd + '.sl2gradient Thilina\n\n' +
        command_cmd + '```.sl2pink``` \n' + desc_cmd + t58 + '_\n' + usage_cmd + '.sl2pink Thilina\n\n' +
        command_cmd + '```.slpubg``` \n' + desc_cmd + t59 + '_\n' + usage_cmd + '.slpubg Thilina\n\n' +
        command_cmd + '```.slroad``` \n' + desc_cmd + t60 + '_\n' + usage_cmd + '.slroad Thilina\n\n' +
        command_cmd + '```.slsad``` \n' + desc_cmd + t61 + '_\n' + usage_cmd + '.slsad Thilina\n\n' +
        command_cmd + '```.slabear``` \n' + desc_cmd + t62 + '_\n' + usage_cmd + '.slabear Thilina\n\n' +
        command_cmd + '```.slpuppy``` \n' + desc_cmd + t63 + '_\n' + usage_cmd + '.slpuppy Thilina\n\n' +
        command_cmd + '```.sl2pubg``` \n' + desc_cmd + t64 + '_\n' + usage_cmd + '.sl2pubg Thilina\n\n' +
        command_cmd + '```.sl3pubg``` \n' + desc_cmd + t65 + '_\n' + usage_cmd + '.sl3pubg Thilina\n\n' +
        command_cmd + '```.slheart``` \n' + desc_cmd + t66 + '_\n' + usage_cmd + '.slheart Thilina\n\n' +
        command_cmd + '```.slangel``` \n' + desc_cmd + t69 + '_\n' + usage_cmd + '.slangel Thilina\n\n' +
        command_cmd + '```.slleaf``` \n' + desc_cmd + t70 + '_\n' + usage_cmd + '.slleaf Thilina\n\n' +
        command_cmd + '```.slgold``` \n' + desc_cmd + t71 + '_\n' + usage_cmd + '.slgold Thilina\n\n' +
        command_cmd + '```.sl2gold``` \n' + desc_cmd + t79 + '_\n' + usage_cmd + '.sl2gold Thilina\n\n' +
        command_cmd + '```.slsnow``` \n' + desc_cmd + t75 + '_\n' + usage_cmd + '.slsnow Thilina\n\n' +
        command_cmd + '```.slballoon``` \n' + desc_cmd + t78 + '_\n' + usage_cmd + '.slballoon Thilina\n\n' +
        command_cmd + '```.slmatrix``` \n' + desc_cmd + t80 + '_\n' + usage_cmd + '.textmatrix Thilina\n\n'
