...
const Thilinamanoj = require('textsewmake'); // Import NPM Package
...
QueenSew.newcmdaddtosew({pattern: '1text$', fromMe: wk, desc: desc_msg}, (async (message, match) => {
    ...
    const msg = command_cmd + '```.sewdevil``` \n' + t1 + '_\n' + usage_cmd + '*.sewdevil Thilina*\n\n' +
        command_cmd + '```.sewbear``` \n' + desc_cmd + t2 + '_\n' + usage_cmd + '*.sewbear Thilina*\n\n' +
        command_cmd + '```.sewwolf``` \n' + desc_cmd + t10 + '_\n' + usage_cmd + '*.sewwolf Thilina;Methsahan*\n\n' +
        command_cmd + '```.sewneon```\n' + desc_cmd + t3 + '_\n' + usage_cmd + '*.sewneon Thilina*\n\n' +
        command_cmd + '```.sew2neon``` \n' + desc_cmd + t4 + '_\n' + usage_cmd + '*.sew2neon Thilina*\n\n' +
        command_cmd + '```.sew3neon``` \n' + desc_cmd + t18 + '_\n' + usage_cmd + '*.sew3neon Thilina*\n\n' +
        command_cmd + '```.sew4neon``` \n' + desc_cmd + t27 + '_\n' + usage_cmd + '*.sew4neon Thilina*\n\n' +
        command_cmd + '```.sewlight``` \n' + desc_cmd + t5 + '_\n' + usage_cmd + '*.sewlight Thilina*\n\n' +
        command_cmd + '```.sewjoker``` \n' + desc_cmd + t6 + '_\n' + usage_cmd + '*.sewjoker Thilina*\n\n' +
        command_cmd + '```.sewninja``` \n' + desc_cmd + t7 + '_\n' + usage_cmd + '*.sewninja Thilina;Methsahan*\n\n' +
        command_cmd + '```.sewglitter``` \n' + desc_cmd + t8 + '_\n' + usage_cmd + '*.sewglitter Thilina*\n\n' +
        command_cmd + '```.sewbokeh``` \n' + desc_cmd + t9 + '_\n' + usage_cmd + '*.sewbokeh Thilina*\n\n' +
        command_cmd + '```.sewmarvel``` \n' + desc_cmd + t11 + '_\n' + usage_cmd + '*.sewmarvel Thilina;Methsahan*\n\n' +
        command_cmd + '```.sew2marvel``` \n' + desc_cmd + t12 + '_\n' + usage_cmd + '*.sew2marvel Thilina;Methsahan*\n\n' +
        command_cmd + '```.sewavengers``` \n' + desc_cmd + t13 + '_\n' + usage_cmd + '*.sewavengers Thilina;Methsahan*\n\n' +
        command_cmd + '```.sewgraf``` \n' + desc_cmd + t15 + '_\n' + usage_cmd + '*.sewgraf Manoj;Thilina*\n\n' +
        command_cmd + '```.sew2graf``` \n' + desc_cmd + t16 + '_\n' + usage_cmd + '*.sew2graf Manoj;Thilina*\n\n' +       
        command_cmd + '```.sewlion``` \n' + desc_cmd + t17 + '_\n' + usage_cmd + '*.sewlion Manoj;Thilina*\n\n' +
        command_cmd + '```.sewice``` \n' + desc_cmd + t19 + '_\n' + usage_cmd + '*.sewice Thilina*\n\n' +
        command_cmd + '```.sewspace``` \n' + desc_cmd + t20 + '_\n' + usage_cmd + '*.sewspace Thilina;Methsahan*\n\n' +
        command_cmd + '```.sewsmoke``` \n' + desc_cmd + t21 + '_\n' + usage_cmd + '*.sewsmoke Thilina*\n\n' + // Thanks for @Unique_hunter for base.
        command_cmd + '```.sewglow``` \n' + desc_cmd + t23 + '_\n' + usage_cmd + '*.sewglow Thilina*\n\n' +
        command_cmd + '```.sewfire``` \n' + desc_cmd + t25 + '_\n' + usage_cmd + '*.sewfire Thilina*\n\n' +
        command_cmd + '```.sewharry``` \n' + desc_cmd + t26 + '_\n' + usage_cmd + '*.sewharry Thilina*\n\n' +
        command_cmd + '```.sewcup``` \n' + desc_cmd + t29 + '_\n' + usage_cmd + '*.sewcup Thilina*\n\n' +
        command_cmd + '```.sewcemetery``` \n' + desc_cmd + t28 + '_\n' + usage_cmd + '*.sewcemetery Thilina*\n\n' +
        command_cmd + '```.sewglitch``` \n' + desc_cmd + t14 + '_\n' + usage_cmd + '*.sewglitch Thilina;Methsahan*\n\n'
    var r_text = new Array ();
        ...
        await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: msg + ' ᴘᴏᴡᴇʀᴅ ʙʏ ᵀʰⁱˡⁱⁿᵃᴮᵒᵗ'  })
        }));
QueenSew.newcmdaddtosew({pattern: 'sewhorror ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    Thilinamanoj.rgmsa("https://textpro.me/create-green-horror-style-text-effect-online-1036.html",
        `${match[1]}`
        ).then(async (data) => { 
          try { 
...
QueenSew.newcmdaddtosew({pattern: 'sewgart ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    Thilinamanoj.ephoto("https://ephoto360.com/tao-hieu-ung-mui-ten-dinh-kem-chu-ky-nhieu-mau-846.html",
        `${match[1]}`
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sewdevil ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    Thilinamanoj.rgmsa("https://textpro.me/create-neon-devil-wings-text-effect-online-free-1014.html",
        `${match[1]}`
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sewbear ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    Thilinamanoj.rgmsa("https://textpro.me/online-black-and-white-bear-mascot-logo-creation-1012.html",
        `${match[1]}`
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sewwolf ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    ...
    Thilinamanoj.rgmsa("https://textpro.me/create-wolf-logo-galaxy-online-936.html",
        [`${topText}`, `${bottomText}`]
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sewwice ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    ...
    Thilinamanoj.rgmsa("https://textpro.me/create-layered-text-effects-online-free-1032.html",
        [`${topText}`, `${bottomText}`]
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sewneon ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    Thilinamanoj.rgmsa("https://textpro.me/create-a-futuristic-technology-neon-light-text-effect-1006.html",
        `${match[1]}`
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sew2neon ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    Thilinamanoj.rgmsa("https://textpro.me/neon-text-effect-online-879.html",
        `${match[1]}`
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sewlight ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    Thilinamanoj.rgmsa("https://textpro.me/thunder-text-effect-online-881.html",
        `${match[1]}`
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sewjoker ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    Thilinamanoj.rgmsa("https://textpro.me/create-logo-joker-online-934.html",
        `${match[1]}`
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sewninja ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    ...
    Thilinamanoj.rgmsa("https://textpro.me/create-ninja-logo-online-935.html",
        [`${topText}`, `${bottomText}`]
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sewglitter ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    Thilinamanoj.rgmsa("https://textpro.me/advanced-glow-text-effect-873.html",
        `${match[1]}`
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sewbokeh ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    Thilinamanoj.rgmsa("https://textpro.me/bokeh-text-effect-876.html",
        `${match[1]}`
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sewmarvel ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    ...
    Thilinamanoj.rgmsa("https://textpro.me/create-logo-style-marvel-studios-online-971.html",
        [`${topText}`, `${bottomText}`]
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sew2marvel ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    ...
    Thilinamanoj.rgmsa("https://textpro.me/create-3d-avengers-logo-online-974.html",
        [`${topText}`, `${bottomText}`]
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sewglitch ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    ...
    Thilinamanoj.rgmsa("https://textpro.me/create-glitch-text-effect-style-tik-tok-983.html",
        [`${topText}`, `${bottomText}`]
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sewgraf ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    ...
    Thilinamanoj.rgmsa("https://textpro.me/create-cool-wall-graffiti-text-effect-online-1009.html",
        [`${topText}`, `${bottomText}`]
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sew2graf ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    ...
    Thilinamanoj.rgmsa("https://textpro.me/create-a-cool-graffiti-text-on-the-wall-1010.html",
        [`${topText}`, `${bottomText}`]
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sewlion ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    ...
    Thilinamanoj.rgmsa("https://textpro.me/create-lion-logo-mascot-online-938.html",
        [`${topText}`, `${bottomText}`]
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sew3neon ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    Thilinamanoj.rgmsa("https://textpro.me/neon-text-effect-online-963.html",
        `${match[1]}`
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sewice ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    Thilinamanoj.rgmsa("https://textpro.me/ice-cold-text-effect-862.html",
        `${match[1]}`
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'space ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    ...
    Thilinamanoj.rgmsa("https://textpro.me/create-space-3d-text-effect-online-985.html",
        [`${topText}`, `${bottomText}`]
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sewsmoke ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    Thilinamanoj.rgmsb("https://photooxy.com/other-design/create-an-easy-smoke-type-effect-390.html",
        `${match[1]}`
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sewfire ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    Thilinamanoj.rgmsb("https://photooxy.com/logo-and-text-effects/realistic-flaming-text-effect-online-197.html",
        `${match[1]}`
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sewharry ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    Thilinamanoj.rgmsb("https://photooxy.com/logo-and-text-effects/create-harry-potter-text-on-horror-background-178.html",
        `${match[1]}`
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sew4neon ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    Thilinamanoj.rgmsb("https://photooxy.com/logo-and-text-effects/illuminated-metallic-effect-177.html",
        `${match[1]}`
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sewcemetery ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    Thilinamanoj.rgmsb("https://photooxy.com/logo-and-text-effects/text-on-scary-cemetery-gate-172.html",
        `${match[1]}`
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
...
QueenSew.newcmdaddtosew({pattern: 'sewcup ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    Thilinamanoj.rgmsb("https://photooxy.com/logo-and-text-effects/put-text-on-the-cup-387.html",
        `${match[1]}`
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
